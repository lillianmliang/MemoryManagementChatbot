            ...
            if (type != tokens.end())
            {
                ...
                if (idToken != tokens.end())
                {
                    ...
                    if (type->second == "NODE")
                    {
                        ...
                        auto newNode = _nodes.begin();
                        for (; newNode !=_nodes.end(); newNode++) 
                        {
                    ...
                    if (type->second == "EDGE")
                    {
                        ...
                        if (parentToken != tokens.end() && childToken != tokens.end())
                        {
                            ...
                            // check if node with this ID exists already
                            auto parentNode = _nodes.begin();
                            for (; parentNode !=_nodes.end(); parentNode++) 
                            {
                                if ((*parentNode)->GetID() == std::stoi(parentToken->second)) break;
                            }

                            auto childNode = _nodes.begin();
                            for (; childNode !=_nodes.end(); childNode++) 
                            {
